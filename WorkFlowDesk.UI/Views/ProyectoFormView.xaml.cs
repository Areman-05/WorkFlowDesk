...
public partial class ProyectoFormView : UserControl
{
    ...
    {
        if (DataContext is ProyectoFormViewModel vm)
    ...
    {
        if (e.Key != Key.Escape || DataContext is not ProyectoFormViewModel vm)
            return;
